...
export default function Modal() {
  ...
  return (
    isOpen && (
      ...
      >
        <div className="relative p-4 lg: w-full max-w-md max-h-full bg-white rounded-lg shadow dark:bg-gray-700 sm: max-w-[90%]">
          {/* Modal Header */}
          <div className="flex items-center sm: w-[90%] justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
